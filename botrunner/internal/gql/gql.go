...
func (g *GQLHelper) CreateClubReward(clubCode string, name string, rewardType string, scheduleType string, amount float64) (uint32, error) {
...
func (g *GQLHelper) BuyIn(gameCode string, amount float64) (*BuyInResp, error) {
...
func (g *GQLHelper) ReloadChips(gameCode string, amount float64) (bool, error) {
