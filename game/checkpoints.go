...
const (
	...
	GameStage__NO_MORE_ACTIONS          uint32 = 6
	GameStage__RESULT                   uint32 = 7
	GameStage__HAND_END                 uint32 = 8
	GameStage__HEADS_UP_PROMPT          uint32 = 9
	GameStage__HEADS_UP_PROMPT_RESPONSE uint32 = 10
)
