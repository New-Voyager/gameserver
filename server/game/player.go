...
func (p *Player) JoinGame(gameID uint64, seatNo uint32, buyIn float64, runItTwice bool, runItTwicePromptResponse bool, postBlind bool) error {
...
func (p *Player) SetupNextHand(num uint32, handSetup HandSetup) error {
	...
	if handSetup.BombPot {
		...
		nextHand.BombPotBet = float64(handSetup.BombPotBet)
