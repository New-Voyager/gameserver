...
func (s *RedisHandsSetupTracker) Load(gameCode string) (*TestHandsSetup, error) {
	return s.load(s.getKey(gameCode))
}

func (s *RedisHandsSetupTracker) load(key string) (*TestHandsSetup, error) {
...
func (s *RedisHandsSetupTracker) Save(gameCode string, handsSetup *TestHandsSetup) error {
	return s.save(s.getKey(gameCode), handsSetup)
}

func (s *RedisHandsSetupTracker) save(key string, handsSetup *TestHandsSetup) error {
